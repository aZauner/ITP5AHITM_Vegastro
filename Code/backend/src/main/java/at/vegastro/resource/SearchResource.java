...
//    public OpenSearchClient client;
    ...
    public HitsMetadata<IndexData> test() throws IOException {
        System.setProperty("javax.net.ssl.trustStore", "src/main/resources/server.keystore");
        System.setProperty("javax.net.ssl.trustStorePassword", "password");

        final HttpHost host = new HttpHost("https", 443, "851b-193-170-158-243.ngrok.io");
        ...
        return client.search(new SearchRequest.Builder().q("restaurantName:Food Palace").build(), IndexData.class).hits();
    }
