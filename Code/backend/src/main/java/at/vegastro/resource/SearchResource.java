    ...
    public void bulkData(List<Restaurant> restaurants){
        ...
        try {
            for(Restaurant restaurant: restaurants){
                ...
                IndexData indexData = new IndexData(restaurant.longitude,restaurant.latitude ,restaurant.description, restaurant.id.toString(), new IndexLocation(restaurant.location.city, restaurant.location.plz.toString(), restaurant.location.street), restaurant.restaurantName, menu, restaurant.type , restaurant.image.id);
